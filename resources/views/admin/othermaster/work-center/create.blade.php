    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row" action="{{ route('work-center.store') }}" method="POST">
                    @csrf

                    {{-- Work Center Name --}}
                    <div class="col-md-12 input-group-adss">
                        <label>Work Center Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="work_center_name" value="{{ old('work_center_name') }}">
                    ...
                    <div class="col-md-12 input-group-adss">
                        ...
                        <textarea class="form-control" name="work_center_description">{{ old('work_center_description') }}</textarea>
